 ...
 */
public class ViewMentorDetails extends javax.swing.JFrame {
    long prn;
    public ViewMentorDetails() {
        initComponents();
    }

    public ViewMentorDetails(long prn) {
        initComponents();
        this.prn=prn;
        Allotment a=new Allotment();
        a=Allotment.getData(prn);
        System.out.println(""+a.getRelationId());
        Mentor m=new Mentor();
        m=Mentor.getData(a.getFacultyId());
        name.setText(m.getName());
        depart.setText(m.getDepartment());
        number.setText(m.getMobileNumber()+"");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2), "MENTOR DETAILS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        depart.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(depart)
                    .addComponent(email, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMentorDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewMentorDetails().setVisible(true);
            }
        });
    }
