 ...
 */
public class ViewWardDetails extends javax.swing.JFrame {
    long lprn;
    Student s=new Student();
    /**
     * Creates new form ViewStudentDetails
     */
    public ViewWardDetails() {
        initComponents();
    }

    public ViewWardDetails(long lprn) {
        initComponents();
        this.lprn=lprn;
        //this.fid=fid;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // TODO add your handling code here:
        new ParentFrame(lprn).setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new ViewMarks(lprn).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewWardDetails().setVisible(true);
            }
        });
    }
